...
<div class="row2">
  <div class="add_member">
    ...
    <?php
      ...
      */
      function renderForm($name, $dob, $contact_no, $address, $company, $email, $gender, $maritial_status, $error)
      {     
       ...
       renderForm($name, $dob, $contact_no, $address, $company, $email, $gender, $maritial_status, $error);
       }
       else
       {
       $query = "INSERT Members SET name='$name', dob='$dob', residential_address='$address', gender='$gender', `maritial status`='$maritial_status', church_id='$_SESSION[church_id]' ";
         if(!empty($company))
         {
